...
// (sketchybar/helpers/event_providers/sketchybar.h). Shared mach-port IPC
// helper both event_providers/{cpu_load,network_load} use to push custom
// events to a running sketchybar instance.
#pragma once
