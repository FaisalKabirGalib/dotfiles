---
name: dart-signals
description: Expert guidance on using Dart Signals in Flutter with flutter_hooks. Covers signals, computed, effects, async signals, and collections. Activates when working with signals package, HookWidget, or reactive state management.
version: 1.0.0
---
