...
Document externally consumed endpoints with the project's OpenAPI approach, test both unit and integration boundaries, and use the `postgres` and `docker` profiles only when those technologies exist in the repository.
